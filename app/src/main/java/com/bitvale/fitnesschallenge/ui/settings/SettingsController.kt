package com.bitvale.fitnesschallenge.ui.settings
 ...
 */
class SettingsController : BaseController<HomeContract.View, HomeContract.Presenter, HomeViewState>(), HomeContract.View {
